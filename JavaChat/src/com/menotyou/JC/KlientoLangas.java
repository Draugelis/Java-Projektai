...
public class KlientoLangas extends JFrame {
    ...
    private static String[] sriftuPavadinimai = { "Amble-Bold.ttf", "Amble-BoldItalic.ttf", "Amble-Italic.ttf", "Amble-Light.ttf", "Amble-LightCondensed.ttf", "Amble-LightCondensedItalic.ttf", "Amble-LightItalic.ttf", "Amble-Regular.ttf", "Anonymous_Pro_B.ttf", "Anonymous_Pro_BI.ttf", "Anonymous_Pro_I.ttf", "Anonymous_Pro.ttf", };
    ...
    private void sukurkLanga() {
        ...
        addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent evt) {
                ...
                try {
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create("http://vtautvydas.fln.lt/SesijuIstorija.php"));
                } catch (IOException e) {
    ...
    public void startKlientas(SvecioPrisijungimas sp) {
        try {
            if (klientas != null) atjunkKlienta();
    ...
    /**
     * Metodas atjungiantis klientą ir priskiriantis jo objetkui null reikšmę.
     */
    public void atjunkKlienta() {
        klientas.atsijunk();
        klientas = null;
    }
    ...
    /**
     * Metodas skirtas ekrane parodyti svarbią informaciją kuri ateina iš serverio.
     * @param pranesimas -> Atsiųstas pranešimas
     */
    public void pranesimas(String pranesimas) {
        JOptionPane.showMessageDialog(null, pranesimas, "Pranešimas", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    /**
     * Funkcija gražina jau esamą šriftą iš Map<String, Font> kintamojo
     * sriftuSaugykla. Jei šrifto nurodytu pavadinimu nėra, bandoma rasti
     * šrifto .ttf failą programos archyve. Neradus, gražinamas 'serif' šriftas.
     *
     * @param pavadinimas -> Šrifto pavadinimas.
     * @return šriftas, kuris buvo parinktas funkcijos.
     */
    ...
    /**
     * Pagrindinis metodas, int main() atitikmuo C++ kalboje.
     *
     * @param args -> Parametrai kurie gali būti nurodyti paleidžiant programą
     * per cmd konsole. Šiuo atvėju funkcija nenaudoja šiu parametrų.
     */
