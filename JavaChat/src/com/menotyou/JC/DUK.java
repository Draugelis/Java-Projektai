...
public class DUK extends JFrame {
    ...
    public DUK() {
        ...
        gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel.createSequentialGroup().addContainerGap().addGroup(gl_panel.createParallelGroup(Alignment.LEADING).addComponent(lblklausimasKK, 0, 0, Short.MAX_VALUE).addComponent(lbliseitiIsKambario, GroupLayout.PREFERRED_SIZE, 558, GroupLayout.PREFERRED_SIZE).addComponent(lblKambarioSav, GroupLayout.PREFERRED_SIZE, 558, GroupLayout.PREFERRED_SIZE).addComponent(lblklausimasKaipSisti, GroupLayout.PREFERRED_SIZE, 558, GroupLayout.PREFERRED_SIZE).addComponent(lblklausimasPKK, GroupLayout.PREFERRED_SIZE, 558, GroupLayout.PREFERRED_SIZE).addComponent(lblklausimasTekstoNustatymas, GroupLayout.PREFERRED_SIZE, 558, GroupLayout.PREFERRED_SIZE)).addContainerGap()));
        gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(
                gl_panel.createSequentialGroup().addComponent(lblklausimasKaipSisti, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lbliseitiIsKambario, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lblKambarioSav, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lblklausimasKK, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lblklausimasPKK, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(lblklausimasTekstoNustatymas, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addContainerGap()));
        ...
        setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[] { getContentPane(), scrollPane, panel, lblklausimasKaipSisti, lblPavadinimas, lblklausimasKK, lbliseitiIsKambario, lblKambarioSav, lblklausimasPKK, lblklausimasTekstoNustatymas }));
        setSize(622, 360);
