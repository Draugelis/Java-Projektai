...
public class Uzsklanda extends JWindow {
	...
	/**
	 * Instantiates a new uzsklanda.
	 *
	 * @param svecias the svecias
	 */
	...
	public void rodytiUzsklanda() {
		...
		JLabel logo = new JLabel(); //TODO add the logo
		logo.setText("");
		...
		JLabel grupeLabel = new JLabel("<html><b>Grupė:</b> P-3/2V </html>");
		grupeLabel.setForeground(Color.DARK_GRAY);
		grupeLabel.setBounds(30, 103, 89, 14);
		getContentPane().add(grupeLabel);
